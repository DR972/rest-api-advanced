...
public class TagControllerTest {
    ...
    void givenParamsList_whenGetListTags_thenReturnStatus200andListTags() {
        ...
        mockMvc.perform(get("/tags")
                ...
                .andExpect(jsonPath("$.entities[0].id", is("1")))
                .andExpect(jsonPath("$.entities[0].name", is("rest")))
                .andExpect(jsonPath("$.entities[1].id", is("2")))
                .andExpect(jsonPath("$.entities[1].name", is("nature")))
                .andExpect(jsonPath("$.entities[2].id", is("3")))
                .andExpect(jsonPath("$.entities[2].name", is("shopping")))
