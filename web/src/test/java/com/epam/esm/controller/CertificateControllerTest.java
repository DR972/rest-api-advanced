...
public class CertificateControllerTest {
    ...
    void givenParamsList_whenGetListCertificates_thenReturnStatus200andListTags() {
        ...
        mockMvc.perform(get("/certificates")
                ...
                .andExpect(jsonPath("$.entities[0].certificateId", is(certificates.get(0).getCertificateId())))
                .andExpect(jsonPath("$.entities[0].name").value(certificates.get(0).getName()))
                .andExpect(jsonPath("$.entities[0].description").value(certificates.get(0).getDescription()))
                .andExpect(jsonPath("$.entities[0].price").value(certificates.get(0).getPrice()))
                .andExpect(jsonPath("$.entities[0].duration").value(certificates.get(0).getDuration()))
                .andExpect(jsonPath("$.entities[0].createDate").value(certificates.get(0).getCreateDate().toString()))
                .andExpect(jsonPath("$.entities[0].lastUpdateDate").value(certificates.get(0).getLastUpdateDate().toString()))
                .andExpect(jsonPath("$.entities[0].tags[0].id").value((certificates.get(0).getTags().get(0).getId())))
                .andExpect(jsonPath("$.entities[0].tags[0].name").value((certificates.get(0).getTags().get(0).getName())))
                .andExpect(jsonPath("$.entities[0].tags[1].id").value((certificates.get(0).getTags().get(1).getId())))
                .andExpect(jsonPath("$.entities[0].tags[1].name").value((certificates.get(0).getTags().get(1).getName())))
                .andExpect(jsonPath("$.entities[0].tags[2].id").value((certificates.get(0).getTags().get(2).getId())))
                .andExpect(jsonPath("$.entities[0].tags[2].name").value((certificates.get(0).getTags().get(2).getName())))

                .andExpect(jsonPath("$.entities[1].certificateId", is(certificates.get(1).getCertificateId())))
                .andExpect(jsonPath("$.entities[1].name").value(certificates.get(1).getName()))
                .andExpect(jsonPath("$.entities[1].description").value(certificates.get(1).getDescription()))
                .andExpect(jsonPath("$.entities[1].price").value(certificates.get(1).getPrice()))
                .andExpect(jsonPath("$.entities[1].duration").value(certificates.get(1).getDuration()))
                .andExpect(jsonPath("$.entities[1].createDate").value(certificates.get(1).getCreateDate().toString()))
                .andExpect(jsonPath("$.entities[1].lastUpdateDate").value(certificates.get(1).getLastUpdateDate().toString()))
                .andExpect(jsonPath("$.entities[1].tags[0].id").value((certificates.get(1).getTags().get(0).getId())))
                .andExpect(jsonPath("$.entities[1].tags[0].name").value((certificates.get(1).getTags().get(0).getName())))
                .andExpect(jsonPath("$.entities[1].tags[1].id").value((certificates.get(1).getTags().get(1).getId())))
                .andExpect(jsonPath("$.entities[1].tags[1].name").value((certificates.get(1).getTags().get(1).getName())))

                .andExpect(jsonPath("$.entities[2].certificateId", is(certificates.get(2).getCertificateId())))
                .andExpect(jsonPath("$.entities[2].name").value(certificates.get(2).getName()))
                .andExpect(jsonPath("$.entities[2].description").value(certificates.get(2).getDescription()))
                .andExpect(jsonPath("$.entities[2].price").value(certificates.get(2).getPrice()))
                .andExpect(jsonPath("$.entities[2].duration").value(certificates.get(2).getDuration()))
                .andExpect(jsonPath("$.entities[2].createDate").value(certificates.get(2).getCreateDate().toString()))
                .andExpect(jsonPath("$.entities[2].lastUpdateDate").value(certificates.get(2).getLastUpdateDate().toString()))
                .andExpect(jsonPath("$.entities[2].tags[0].id").value((certificates.get(2).getTags().get(0).getId())))
                .andExpect(jsonPath("$.entities[2].tags[0].name").value((certificates.get(2).getTags().get(0).getName())))
                .andExpect(jsonPath("$.entities[2].tags[1].id").value((certificates.get(2).getTags().get(1).getId())))
                .andExpect(jsonPath("$.entities[2].tags[1].name").value((certificates.get(2).getTags().get(1).getName())))
